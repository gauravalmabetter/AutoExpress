        ...
        User.findOne({ email }).exec(async (err, user) => {
          if (err) {
            ...
            if (user) {
              ...
              let password = email+"absadascdsfsdfsd"
              const user = await User.create({
                name,
                email,
                password
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="esd-block-text es-p25t es-p40r es-p40l" align="center">
                                                                                            <p><span style="font-size:16px;">You need not worry. Eager to see you on auto express😎&nbsp;.</span><br><br><br><em><strong><span style="font-size:17px;">Enter the OTP provided below.</span></strong></em></p>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
